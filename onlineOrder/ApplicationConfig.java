...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() { // connect to database
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "database-onlineorder.c876bpwajhvb.us-west-1.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "=MSky020929M";
